...
class Client:
    ...
    def __init__(self, master, serveraddr, serverport, rtpport, filename):
        ...
        self.progressBar = ttk.Progressbar(self.master,orient = HORIZONTAL, length = 600, mode='determinate')
    ...
    def createWidgets(self):
        ...
        self.teardown.grid(row=4, column=2, padx=2, pady=2)
        ...
        self.describe.grid(row=4, column=0, padx=2, pady=2)
